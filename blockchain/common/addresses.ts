...
export const ADDRESSES = {
  ...
  A7A5: process.env.A7A5_ADDRESS ?? '0x6fA0BE17e4beA2fCfA22ef89BF8ac9aab0AB0fc9',
  WA7A5: process.env.WA7A5_ADDRESS ?? '0xF442fF10b8deF89514560A66C0AD28777094636a',
  ...
  V3_FEE_TIER: Number(process.env.UNIV3_FEE_TIER ?? '500'),
  ...
  ENTRYPOINT_V08: process.env.ENTRYPOINT ?? '0x4337084D9E255Ff0702461CF8895CE9E3b5Ff108',
  ENTRYPOINT_V09: '0x433709009B8330FDa32311DF1C2AFA402eD8D009',
  // Chainlink USDT/ETH feed (returns ETH-per-USDT, 18 decimals).
  CHAINLINK_USDT_ETH: process.env.CHAINLINK_USDT_ETH ?? '0xEe9F2375b4bdF6387aa8265dD4FB8F16512A1d46',
  ...
  A7A5_WHALE: process.env.A7A5_WHALE ?? '0xF442fF10b8deF89514560A66C0AD28777094636a', // WA7A5 contract holds A7A5 backing
  WA7A5_WHALE: process.env.WA7A5_WHALE ?? '0xB6d629cb247333DD5e273B75741c55DfEca6f6e9', // V3 pool holds wA7A5
  USDT_WHALE: process.env.USDT_WHALE ?? '0xF977814e90dA44bFA03b6295A0616a897441aceC', // Binance hot wallet
  USDC_WHALE: process.env.USDC_WHALE ?? '0x88e6A0c2dDD26FEEb64F039a2c41296FcB3f5640', // USDC/ETH V3 0.05% pool
  WETH_WHALE: process.env.WETH_WHALE ?? '0x11b815efB8f581194ae79006d24E0d814B7697F6', // WETH/USDT V3 0.05% pool
} as const;
